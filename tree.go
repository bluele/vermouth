...
func (n *node) addRoute(path string, handle ContextHandlerFunc) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(numParams uint8, path, fullPath string, handle ContextHandlerFunc) {
...
// given path.
func (n *node) getValue(path string) (handle ContextHandlerFunc, p Params, tsr bool) {
